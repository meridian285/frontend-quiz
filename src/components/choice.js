    ...
    processQuizzes() {
        ...
        if (this.quizzes && this.quizzes.length > 0) {
            this.quizzes.forEach(quiz => {
                ...
                const choiceOptionTexElement = document.createElement('div');
                choiceOptionTexElement.className = 'choice-option-text';
                choiceOptionTexElement.innerText = quiz.name;
                ...
                choiceOptionElement.appendChild(choiceOptionTexElement);
